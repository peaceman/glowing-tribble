...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'edmpurchase_purchase', (
        ...
        db.send_create_signal(u'edmpurchase', ['Purchase'])


    def backwards(self, orm):
        # Deleting model 'Purchase'
        db.delete_table(u'edmpurchase_purchase')
