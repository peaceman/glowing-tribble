...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserSessionVisitedUrl'
        db.create_table(u'edmuser_usersessionvisitedurl', (
        ...
        db.send_create_signal(u'edmuser', ['UserSessionVisitedUrl'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserSessionVisitedUrl'
        db.delete_table(u'edmuser_usersessionvisitedurl')
    ...
    models = {
        ...
        u'edmuser.usersessionvisitedurl': {
            'Meta': {'object_name': 'UserSessionVisitedUrl'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
