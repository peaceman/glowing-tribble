...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'edmuser_useragent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'edmuser', ['UserAgent'])

        # Adding model 'UserSession'
        db.create_table(u'edmuser_usersession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ip_address', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39)),
            ('user_agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edmuser.UserAgent'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'edmuser', ['UserSession'])

        # Adding model 'UserSessionVisitedUrls'
        db.create_table(u'edmuser_usersessionvisitedurls', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edmuser.UserSession'])),
        ))
        db.send_create_signal(u'edmuser', ['UserSessionVisitedUrls'])


    def backwards(self, orm):
        # Deleting model 'UserAgent'
        db.delete_table(u'edmuser_useragent')

        # Deleting model 'UserSession'
        db.delete_table(u'edmuser_usersession')

        # Deleting model 'UserSessionVisitedUrls'
        db.delete_table(u'edmuser_usersessionvisitedurls')
