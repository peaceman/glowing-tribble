...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MusicPlugin.software'
        db.delete_column(u'edmmusic_musicplugin', 'software_id')

        # Adding field 'MusicPlugin.program'
        db.add_column(u'edmmusic_musicplugin', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edmmusic.MusicProgram']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MusicPlugin.software'
        db.add_column(u'edmmusic_musicplugin', 'software',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edmmusic.MusicProgram']),
                      keep_default=False)

        # Deleting field 'MusicPlugin.program'
        db.delete_column(u'edmmusic_musicplugin', 'program_id')
